...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="/opt/ml/input/data/training/train",
    )
    parser.add_argument(
        "-o",
        "--output_dir",
    ...
    #add by shishuai
#     os.makedirs(os.path.join(args.output_dir, 'new'))
    
    print("Input dir : ", args.input_dir)
    if args.debug:
        process_audio(os.path.join(args.input_dir, 'train'), os.path.join(args.output_dir, 'train'), debug=True)
    else:
        process_audio(os.path.join(args.input_dir,  'test'), os.path.join(args.output_dir, 'test'))
        process_audio(os.path.join(args.input_dir,  'train'), os.path.join(args.output_dir, 'train'))
#         process_audio(os.path.join(args.input_dir,  'new'), os.path.join(args.output_dir, 'new'))
